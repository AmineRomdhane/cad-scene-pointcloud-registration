...
Dataset:
- results/learning_data_synthetic_plus_real_curated_clean/all_correspondences.csv
...
Outputs:
- results/tables/mlp_real_holdout_clean_results_by_case.csv
- results/tables/mlp_real_holdout_clean_results_average.csv
- results/tables/mlp_real_holdout_clean_threshold_results_by_case.csv
- results/tables/mlp_real_holdout_clean_threshold_results_average.csv
"""
...
INPUT_CSV = (
    BASE_DIR
    / "results"
    / "learning_data_synthetic_plus_real_curated_clean"
    / "all_correspondences.csv"
)

MODEL_NAME = "MLP_real_holdout_clean"
...
def main():
    ...
    by_case_path = TABLE_DIR / "mlp_real_holdout_clean_results_by_case.csv"
    avg_path = TABLE_DIR / "mlp_real_holdout_clean_results_average.csv"

    threshold_by_case_path = TABLE_DIR / "mlp_real_holdout_clean_threshold_results_by_case.csv"
    threshold_avg_path = TABLE_DIR / "mlp_real_holdout_clean_threshold_results_average.csv"
