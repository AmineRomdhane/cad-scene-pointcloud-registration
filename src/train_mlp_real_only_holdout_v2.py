...
Outputs:
- results/tables/mlp_real_only_holdout_v2_results_by_case.csv
- results/tables/mlp_real_only_holdout_v2_results_average.csv
- results/tables/mlp_real_only_holdout_v2_threshold_results_by_case.csv
- results/tables/mlp_real_only_holdout_v2_threshold_results_average.csv
"""
...
MODEL_NAME = "MLP_real_only_holdout_v2"
...
def main():
    ...
    # Real-only experiment:
    # remove all synthetic correspondences before train/validation/test splitting.
    ...
    by_case_path = TABLE_DIR / "mlp_real_only_holdout_v2_results_by_case.csv"
    avg_path = TABLE_DIR / "mlp_real_only_holdout_v2_results_average.csv"

    threshold_by_case_path = TABLE_DIR / "mlp_real_only_holdout_v2_threshold_results_by_case.csv"
    threshold_avg_path = TABLE_DIR / "mlp_real_only_holdout_v2_threshold_results_average.csv"
