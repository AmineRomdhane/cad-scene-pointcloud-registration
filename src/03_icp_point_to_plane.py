...
if __name__ == "__main__":
    ...
    reference_down.estimate_normals(
    ...
    observation_down.estimate_normals(
        o3d.geometry.KDTreeSearchParamHybrid(
            radius=normal_radius,
            max_nn=normal_max_nn
        )
    ...
    np.savetxt(MATRICES_DIR / "T_est_point_to_plane.txt", T_est)

    o3d.io.write_point_cloud(
        str(POINTCLOUDS_DIR / "aligned_observation_point_to_plane.ply"),
        aligned_observation
    )
    ...
    print("\nSaved:")
    print(MATRICES_DIR / "T_est_point_to_plane.txt")
    print(TABLES_DIR / "icp_results.csv")
    print(POINTCLOUDS_DIR / "aligned_observation_point_to_plane.ply")
    ...
    if VISUALIZE:
        ...
        o3d.visualization.draw_geometries(
            ...
            window_name="Before ICP point-to-plane"
        )

        o3d.visualization.draw_geometries(
            [reference_down, aligned_observation],
            window_name="After ICP point-to-plane"
        )
