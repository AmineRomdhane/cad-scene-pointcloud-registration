...
Outputs:
- results/tables/mlp_real_holdout_clean_v2_results_by_case.csv
- results/tables/mlp_real_holdout_clean_v2_results_average.csv
- results/tables/mlp_real_holdout_clean_v2_threshold_results_by_case.csv
- results/tables/mlp_real_holdout_clean_v2_threshold_results_average.csv
"""
...
MODEL_NAME = "MLP_real_holdout_clean_v2"
...
def main():
    ...
    by_case_path = TABLE_DIR / "mlp_real_holdout_clean_v2_results_by_case.csv"
    avg_path = TABLE_DIR / "mlp_real_holdout_clean_v2_results_average.csv"

    threshold_by_case_path = TABLE_DIR / "mlp_real_holdout_clean_v2_threshold_results_by_case.csv"
    threshold_avg_path = TABLE_DIR / "mlp_real_holdout_clean_v2_threshold_results_average.csv"
